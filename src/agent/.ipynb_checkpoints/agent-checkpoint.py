...
from src.env_desc import data_lake_dict, library_content_dict
from src.llm import SourceType, get_llm
from src.tools.support_tools import run_python_repl
...
class A1:
    ...
    def add_tool(self, api):
        ...
        try:
            ...
            if not hasattr(builtins, "_histopath_custom_functions"):
                builtins._histopath_custom_functions = {}
            builtins._histopath_custom_functions[schema["name"]] = api
...
To achieve this, you will be using an interactive coding environment equipped with a variety of tool functions, data, softwares, and models to assist you throughout the process.
...
"""
        ...
        if self.use_tool_retriever:
            selected_resources_names = self._prepare_resources_for_retrieval(prompt)
            self.update_system_prompt_with_selected_resources(selected_resources_names, image_path=image_path)
